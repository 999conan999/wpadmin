        ...
        data.forEach((e,i) => {
            result.push(
                <Table.Row key={i} className='danhvt'>
                    <Table.Cell><b><a href={e.url}  target="_blank">{e.name} <i class="fa-solid fa-arrow-up-right-from-square" style={{'fontSize':'10px'}}></i></a></b></Table.Cell>
                    <Table.Cell>
